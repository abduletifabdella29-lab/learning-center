...
### *A personal hub for everything I'm learning, building, and figuring out.*
...
**learning-center** is not a portfolio, and it's not tied to a single course — it's my **ongoing learning headquarters**.
...
HTML · CSS · Responsive Design · Bootstrap · UI/UX basics · First deployments

</td><td>✅</td></tr>
<tr><td>

**2️⃣ Programming & JavaScript Foundations**
Programming fundamentals · JavaScript · Algorithms · DOM · Event handling · jQuery

</td><td>✅</td></tr>
<tr><td>

**3️⃣ Backend & React Development**
Git · Node.js · Express.js · MySQL · React · Async JS · Hooks · APIs · Routing
...
|---|---|---|
| 📝 | **Learning Notes** | Concepts explained in my own words |
| 💻 | **Practice** | Small exercises and coding drills |
...
### 🌱 A developer's personal learning journey —
**organized, honest, continuously evolving, and documented as they grow.**
